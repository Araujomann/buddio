...
export const Chat: React.FC<ChatProps> = ({ switchTheme }) => {
    ...
    useEffect(() => {
        ...
        const fetchPreferences = async () => {
            try {
                ...
                console.log('Eis o id da conversaaaaa: ', conversationId);
    ...
    const updateChatBackground = async (chatBackground: string) => {
        try {
            ...
            setSelectBackground(response.data.background);
        } catch (error: any) {
    ...
    return (
        <div className="flex flex-col h-screen w-screen">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <button
                                    className="flex items-center justify-center hover:ring-0 hover:outline-none w-full h-8 bg-[#292929]  hover:bg-[#181818]"
                                    onClick={() => {
                                        if (
            ...
            {/* Header */}
            <div className="absolute w-full flex items-center justify-between  pr-4 py-4 border-b bg-black/60 shadow-lg border border-white/20 backdrop-blur-md">
                <div className="flex items-center">
                    ...
                    <div className="flex flex-col text-white font-montserrat font-semibold px-2">
                        <p>{user?.username}</p>

                        <p
                            className={`${
                                isOnline ? 'text-[#16a340]' : 'text-[#808080]'
            ...
            >
                {chatMessages.map((msg, index) => {
                    ...
                    return (
                        <div>
                            {showDate && (
                                <div className="bg-black/60 bg-flex mx-auto items-center font-normal py-1 border border-gray-600 px-2 rounded-md w-fit justify-center text-center text-xs text-[#ffffff] my-4">
                                    {messageDate}
                                </div>
                            )}
            ...
            <div className="absolute bottom-3 w-full flex items-center gap-2 px-2">
                <div className="w-full flex items-center bg-white p-1 rounded-full">
                    <input
                        type="text"
                        value={newMessage}
                        ...
                        className="flex-1 px-4 py-2 rounded-full w-full text-black bg-white border-none focus:outline-none"
                    />
                </div>
